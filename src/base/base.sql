...
-- crm.contract_settings definition
...
-- crm.ticket_settings definition
...
-- crm.customer_login_info definition
...
-- crm.trigger_contract definition
...
-- crm.google_drive_file definition
...
create table notification(
  ...
  type ENUM('lead', 'contract', 'ticket')
);
...
CREATE TABLE depense (
   ...
   CONSTRAINT fk_ticket_lead FOREIGN KEY (ticket_id) REFERENCES trigger_ticket(ticket_id),
   CONSTRAINT fk_lead FOREIGN KEY (lead_id) REFERENCES trigger_lead(lead_id)
);
